...
Below we implement our own extention of Adam algorithm to federated optimization for heterogeneous setting
...
def init_stepsize(X, la, num_local_steps, batch_size):
    ...
    #return 1 /(10*L)
    return 0.005/num_local_steps  # homo case
...
experiment_name = "local_adam_hetero"
...
w_avg, loss, f_grad_norms, its_comm, epochs,  W_prev, V_prev, M_prev = init_estimates (X_full, y_full, la, num_workers, is_continue, experiment, logs_path, loss_func)
